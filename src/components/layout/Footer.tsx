          ...
          <div className='col-span-1 md:col-span-1'>
            <Link href='/' className='flex items-center'>
              <span className='font-serif text-2xl font-bold text-white'>
                Natura<span className='text-secondary-400'>Soap</span>
              </span>
            </Link>
            <p className='mt-3 text-sm text-neutral-300'>
              Jabones artesanales elaborados con ingredientes naturales para el
              cuidado y bienestar de tu piel.
            </p>
          </div>
          ...
          <div>
            ...
            <form className='flex'>
              <input
                ...
                className='px-3 py-2 bg-primary-800 text-white rounded-l-md focus:outline-none focus:ring-1 focus:ring-secondary-400 text-sm w-full'
              />
              <button
                type='submit'
